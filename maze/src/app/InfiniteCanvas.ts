export class InfiniteCanvas {
  ...
  constructor(cellSize = 40) {
    ...
    if (canvas && canvas instanceof HTMLCanvasElement) {
      ...
      if (context) {
        ...
        this.context.scale(InfiniteCanvas.getPixelRatio(), InfiniteCanvas.getPixelRatio());
        this.#draw();
      } else {
  ...
  #drawGrid(): void {
    if (this.canvas && this.context) {
      ...
      const fs = this.#scale * 10;
      this.context.font = (fs) + "px serif";
